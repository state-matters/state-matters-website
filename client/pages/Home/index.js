...
const Banner = props => (<BannerWrapper className="container">
  ...
  render = _ => {
    return (<React.Fragment>
      ...
      <Banner img="https://user-images.githubusercontent.com/36746528/46442397-256b9d00-c72f-11e8-9e54-f2d08ac60003.png">
        ...
        <BlockLink style={{
            marginTop: "1rem"
          }} color={theme.colors.grey["700"]} href="https://ballotpartyil.ballotready.org/" target="_blank">
          Sign up to host
        </BlockLink>
        <h3 style={{
            marginTop: "2rem"
        ...
        <BlockLink style={{
            marginTop: "1rem"
          }} color={theme.colors.grey["700"]} href=" https://www.chicagoideas.com/events/tools-for-turnout" target="_blank">
          Join us
        </BlockLink>
        <Resources >

              <h3 >Get ready Illinois, we’ve got an election!</h3>

              <h4>Early Voting Starts Monday, October 22nd.</h4>

              <h4>Election Day is Tuesday, November 6th, 2018.</h4>

              <div className="home__links">
                <BlockLink style={{
                    marginTop: "1rem"
                  }} color={theme.colors.grey["700"]} href="https://ova.elections.il.gov/registrationlookup.aspxt" target="_blank">
                  Check if you're registered to vote!
                </BlockLink>
                <BlockLink style={{
                    marginTop: "1rem"
                  }} color={theme.colors.grey["700"]} href="https://ova.elections.il.gov/Step0.aspx#" target="_blank">
                  Register to Vote!
                </BlockLink>
              </div>
        </Resources>
        ...
        <Grid container="container">
          <Column mdOffset={2} sm={8}>
            ...
            <div className="home__links">
              ...
              <Donate>
                {
                  props => (<BlockLink {...props} className="primary">
                    Donate
                  </BlockLink>)
                }
              </Donate>
...
export default connect(state => ({subscribed: state.subscriptions.subscribed}), {handleSubscribe})(Home)
